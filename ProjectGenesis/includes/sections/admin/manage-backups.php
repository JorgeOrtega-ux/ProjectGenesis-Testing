...
// 1. Comprobar si estamos en modo "confirmar restauración"
// Las funciones formatBackupSize() y formatBackupDate() vienen de config/router.php
if (isset($_GET['file']) && !empty($_GET['file'])) {
    
    // --- INICIO DE LÓGICA (MOVIDA DESDE router.php) ---
    ...
    if (empty($backupFileName) || !file_exists($filePath) || !is_readable($filePath)) {
        ...
        // --- INICIO DE HTML (MOVIDO DESDE restore-backup.php) ---
?>
...
<?php
    ...
    // --- MODO LISTA (CÓDIGO ORIGINAL DE manage-backups.php) ---
...
<?php
} // --- FIN DE LA MODIFICACIÓN (cierre del 'else') ---
?>