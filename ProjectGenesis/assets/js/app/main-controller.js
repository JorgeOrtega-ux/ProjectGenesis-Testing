...
function initMainController() {
    ...
    document.body.addEventListener('click', async function (event) {
        ...
        if (action.startsWith('toggle')) {
            ...
            // Añadimos 'toggleModuleNotifications' para que este controlador lo ignore.
            const managedActions = [
                ...
                'toggleModuleNotifications' // <--- ¡AÑADIDO!
            ];
            // --- ▲▲▲ FIN DE LA MODIFICACIÓN ▲▲▲ ---

            if (managedActions.includes(action)) {
                return; // Dejamos que el módulo específico (notification-manager) se encargue.
            }
