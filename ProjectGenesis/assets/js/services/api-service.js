// FILE: assets/js/services/api-service.js
...
async function _post(url, formData) {
    ...
    try {
        ...
        response = await fetch(url, {
            method: 'POST',
            body: formData,
            cache: 'no-store', // No guardar en caché la petición
            headers: {
                'Cache-Control': 'no-cache' // Encabezado extra para máxima compatibilidad
            }
        });
